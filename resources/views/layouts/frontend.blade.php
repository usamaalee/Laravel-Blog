...
<body class=" ">
        ...
        @if(Session::has('subsrcibed'))
                    <script>toastr.success("{{ Session::get('subsrcibed') }}")</script>
        @endif
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5bdb2ec14cab5d8c"></script>
